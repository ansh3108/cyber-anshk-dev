...
export function Footer() {
  return (
    <footer className="py-12 mt-32 border-t border-zinc-200 dark:border-zinc-800/50 flex flex-col md:flex-row items-center justify-end gap-4 font-mono text-[10px] uppercase tracking-widest text-zinc-400">
